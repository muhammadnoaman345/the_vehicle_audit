...
export default function Footer() {
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center items-center justify-around gap-6 border-2 border-primary rounded-tl-4xl rounded-br-4xl">
      ...
      <div className="flex flex-col items-center items-center justify-around sm:justify-around gap-6 border-2 border-primary rounded-tl-4xl rounded-br-4xl">
        <p className="text-white font-ancola tracking-wider sm:text-lg xl:text-2xl font-thin">
          Get in touch
        </p>
